...
def find_nearby_neighborhoods(location, neighborhoods, buffer_dist = 0.015):
    ''' Finds all neighborhoods within a ~1 mile radius of input location '''
...
def get_healthy_suggestions(location, neighborhoods, price_range = 0.15, buffer_dist = 0.015):
    ''' Returns all neighborhoods within your price range (+/- 15% default)
    that also have lower mean pollutant exposures'''
